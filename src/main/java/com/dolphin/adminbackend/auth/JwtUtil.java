...
public class JwtUtil {
    ...
    /*
     * @PostConstruct Initialization: The init() method is annotated
     * with @PostConstruct. This ensures that it's called after dependency injection
     * is complete, so the secretKey will have the value from the environment
     * variable by the time this method runs. Crucially, the jwtParser is
     * initialized here, after the secret key is available.
     */
    @PostConstruct
