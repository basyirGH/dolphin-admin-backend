...
public interface OrderRepo extends JpaRepository<Order, Long> {
         ...
         */
        // @Query("SELECT new
        // com.dolphin.adminbackend.model.dto.queryresult.RevenueByCategoryOverTime(p.category.id,
        // c.name, o.orderDate, "
        // +
        ...
        // "AND FUNCTION('TIME_FORMAT', o.orderDate, '%H:%i:%s') =
        // FUNCTION('TIME_FORMAT', CURRENT_TIME, '%H:%i:%s') ")
        ...
        // "and time_format(order_date, '%H:%i') <= time_format(current_time(),
        // '%H:%i')", nativeQuery = true)
